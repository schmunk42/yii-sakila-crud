<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-random', 'items'=>array(array('icon'=>'circle-arrow-left','label'=>'Rental', 'url' =>array('rental/admin')),array('icon'=>'circle-arrow-left','label'=>'Customer', 'url' =>array('customer/admin')),array('icon'=>'circle-arrow-left','label'=>'Staff', 'url' =>array('staff/admin')),
            )
          ),
        ),
    ));
