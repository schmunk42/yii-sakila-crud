                            ...
                            <div class='controls'>
                               ...
                               <?php echo $form->error($model,'first_name') ?>
                                <span class="help-block">
                                    <?php echo ($t = Yii::t('crud', 'Actor.first_name') != 'Actor.first_name')?$t:'' ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class='controls'>
                               ...
                               <?php echo $form->error($model,'last_name') ?>
                                <span class="help-block">
                                    <?php echo ($t = Yii::t('crud', 'Actor.last_name') != 'Actor.last_name')?$t:'' ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class='controls'>
                               ...
                               <?php echo $form->error($model,'last_update') ?>
                                <span class="help-block">
                                    <?php echo ($t = Yii::t('crud', 'Actor.last_update') != 'Actor.last_update')?$t:'' ?>
                                </span>
                            </div>
                        </div>
                                </div>
    ...
    <div class="form-actions">
        ...
        <?php
            ...
            Yii::t('crud', 'Cancel'), array(
                'submit' => (isset($_GET['returnUrl']))?$_GET['returnUrl']:array('actor/admin'),
                'class' => 'btn'
            ));
