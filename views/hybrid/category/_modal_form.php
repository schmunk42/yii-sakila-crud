...
<?php
    $this->renderPartial('/sakila/hybrid/category/_elements', array(
        'model' => $model,
        'form' => $form,
    ));
    ?>
...
<div class="modal-footer">
    ...
    <?php
    echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('sakila/hybrid/category/editableCreator', 'render' => true)), array(
        'dataType' => 'json',
        'type' => 'post',
