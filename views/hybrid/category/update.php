...
<h1>
    <?php echo Yii::t('crud','Category')?> <small><?php echo Yii::t('crud','Update')?> #<?php echo $model->category_id ?></small></h1>
        ...
        'buttons'=>array(
            ...
            array(
                ...
                'url'=>array(
                    ...
                    'Film' => array('film_category(category_id, film_id)'=>$model->{$model->tableSchema->primaryKey})
                    )
                ),
            ),
        )
