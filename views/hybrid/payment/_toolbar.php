<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'rental - Rental', 'url' =>array('/sakila/hybrid/rental/admin')),array('label'=>'customer - Customer', 'url' =>array('/sakila/hybrid/customer/admin')),array('label'=>'staff - Staff', 'url' =>array('/sakila/hybrid/staff/admin')),
            )
          ),
        ),
    ));
