...
<div class="modal-header">
    <button type="button" class="close" data-toggle="modal" data-target="#<?php echo $formId; ?>-modal">×</button>
        <h3><?php echo Yii::t('crud', 'Create {model}', array('{model}' => Yii::t('crud', 'Actor'))); ?></h3>
</div>
<div class="modal-body">

<?php
    $this->renderPartial('/sakila/hybrid/actor/_elements', array(
        'model' => $model,
        'form' => $form,
    ));
    ?>
...
<div class="modal-footer">
    ...
    <?php
    echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('sakila/hybrid/actor/editableCreator', 'render' => true)), array(
        'dataType' => 'json',
        'type' => 'post',
