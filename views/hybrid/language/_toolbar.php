<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'films - Film', 'url' =>array('/sakila/hybrid/film/admin')),array('label'=>'films1 - Film', 'url' =>array('/sakila/hybrid/film/admin')),
            )
          ),
        ),
    ));
