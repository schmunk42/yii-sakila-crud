<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'store - Store', 'url' =>array('/sakila/hybrid/store/admin')),array('label'=>'film - Film', 'url' =>array('/sakila/hybrid/film/admin')),array('label'=>'rentals - Rental', 'url' =>array('/sakila/hybrid/rental/admin')),
            )
          ),
        ),
    ));
