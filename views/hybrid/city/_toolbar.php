<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'addresses - Address', 'url' =>array('/sakila/hybrid/address/admin')),array('label'=>'country - Country', 'url' =>array('/sakila/hybrid/country/admin')),
            )
          ),
        ),
    ));
