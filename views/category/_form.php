                            ...
                            <div class='controls'>
                               ...
                               <?php echo $form->error($model,'name') ?>
                                <span class="help-block">
                                    <?php echo ($t = Yii::t('crud', 'Category.name') != 'Category.name')?$t:'' ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class='controls'>
                               ...
                               <?php echo $form->error($model,'last_update') ?>
                                <span class="help-block">
                                    <?php echo ($t = Yii::t('crud', 'Category.last_update') != 'Category.last_update')?$t:'' ?>
                                </span>
                            </div>
                        </div>
                                </div>
    ...
    <div class="form-actions">
        ...
        <?php
            ...
            Yii::t('crud', 'Cancel'), array(
                'submit' => (isset($_GET['returnUrl']))?$_GET['returnUrl']:array('category/admin'),
                'class' => 'btn'
            ));
