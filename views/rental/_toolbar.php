<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-random', 'items'=>array(array('icon'=>'arrow-right','label'=>'Payments', 'url' =>array('payment/admin')),array('icon'=>'circle-arrow-left','label'=>'Staff', 'url' =>array('staff/admin')),array('icon'=>'circle-arrow-left','label'=>'Inventory', 'url' =>array('inventory/admin')),array('icon'=>'circle-arrow-left','label'=>'Customer', 'url' =>array('customer/admin')),
            )
          ),
        ),
    ));
