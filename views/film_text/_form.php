                            ...
                            <div class='controls'>
                               ...
                               <?php echo $form->error($model,'film_id') ?>
                                <span class="help-block">
                                    <?php echo ($t = Yii::t('crud', 'Film_text.film_id') != 'Film_text.film_id')?$t:'' ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class='controls'>
                               ...
                               <?php echo $form->error($model,'title') ?>
                                <span class="help-block">
                                    <?php echo ($t = Yii::t('crud', 'Film_text.title') != 'Film_text.title')?$t:'' ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class='controls'>
                               ...
                               <?php echo $form->error($model,'description') ?>
                                <span class="help-block">
                                    <?php echo ($t = Yii::t('crud', 'Film_text.description') != 'Film_text.description')?$t:'' ?>
                                </span>
                            </div>
                        </div>
                                </div>
    ...
    <div class="form-actions">
        ...
        <?php
            ...
            Yii::t('crud', 'Cancel'), array(
                'submit' => (isset($_GET['returnUrl']))?$_GET['returnUrl']:array('film_text/admin'),
                'class' => 'btn'
            ));
