<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-random', 'items'=>array(array('icon'=>'arrow-right','label'=>'Customers', 'url' =>array('customer/admin')),array('icon'=>'arrow-right','label'=>'Inventories', 'url' =>array('inventory/admin')),array('icon'=>'arrow-right','label'=>'Staffs', 'url' =>array('staff/admin')),array('icon'=>'circle-arrow-left','label'=>'ManagerStaff', 'url' =>array('staff/admin')),array('icon'=>'circle-arrow-left','label'=>'Address', 'url' =>array('address/admin')),
            )
          ),
        ),
    ));
