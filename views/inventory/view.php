    ...
    'attributes'=>array(
        ...
        array(
            ...
            'value'=>($model->film !== null)?CHtml::link(
                            ...
                            array('film/view','film_id'=>$model->film->film_id),
                            array('class'=>'')).' '.CHtml::link(
                            '<i class="icon icon-pencil"></i> ',
                            array('film/update','film_id'=>$model->film->film_id),
                            array('class'=>'')):'n/a',
            'type'=>'html',
        ),
        array(
            ...
            'value'=>($model->store !== null)?CHtml::link(
                            ...
                            array('store/view','store_id'=>$model->store->store_id),
                            array('class'=>'')).' '.CHtml::link(
                            '<i class="icon icon-pencil"></i> ',
                            array('store/update','store_id'=>$model->store->store_id),
                            array('class'=>'')):'n/a',
            'type'=>'html',
        ),
        'last_update',
