<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-random', 'items'=>array(array('icon'=>'circle-arrow-left','label'=>'Store', 'url' =>array('store/admin')),array('icon'=>'circle-arrow-left','label'=>'Film', 'url' =>array('film/admin')),array('icon'=>'arrow-right','label'=>'Rentals', 'url' =>array('rental/admin')),
            )
          ),
        ),
    ));
