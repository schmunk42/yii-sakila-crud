...
$this->menu=array(
	...
	array('label'=>'Update' . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->language_id)),
	array('label'=>'Delete' . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->language_id), 'confirm'=>'Are you sure you want to delete this item?')),
...
?><h2><?php echo GxHtml::encode($model->getRelationLabel('films1')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
