...
$this->menu=array(
	...
	array('label'=>'Update' . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->customer_id)),
	array('label'=>'Delete' . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->customer_id), 'confirm'=>'Are you sure you want to delete this item?')),
