...
$this->menu=array(
	...
	array('label'=>'Update' . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->inventory_id)),
	array('label'=>'Delete' . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->inventory_id), 'confirm'=>'Are you sure you want to delete this item?')),
...
array(
			'name' => 'film',
			'type' => 'raw',
			'value' => $model->film !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->film)), array('film/view', 'id' => GxActiveRecord::extractPkValue($model->film, true))) : null,
			),
array(
			'name' => 'store',
			'type' => 'raw',
