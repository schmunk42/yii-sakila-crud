        ...
        <div class="span8"> <!-- main inputs -->
            ...
            <div class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            ...
                            <span class="help-block">
                                ...
                                <?php
                                echo ($t = Yii::t('crud', 'City.city_id') != 'City.city_id')?$t:''
                                ?>
                                                            </span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <?php
                            echo $form->textField($model,'city',array('size'=>50,'maxlength'=>50));
                            echo $form->error($model,'city')
                            ?>
                            <span class="help-block">
                                
                                <?php
                                echo ($t = Yii::t('crud', 'City.city') != 'City.city')?$t:''
                                ?>
                                                            </span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            ...
                            <span class="help-block">
                                ...
                                <?php
                                echo ($t = Yii::t('crud', 'City.country_id') != 'City.country_id')?$t:''
                                ?>
                                                            </span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            ...
                            <span class="help-block">
                                ...
                                <?php
                                echo ($t = Yii::t('crud', 'City.last_update') != 'City.last_update')?$t:''
                                ?>
                                                            </span>
                        </div>
                    </div>
    ...
    <div class="form-actions">
        ...
        <?php
            ...
            Yii::t('crud', 'Cancel'), array(
                'submit' => (isset($_GET['returnUrl']))?$_GET['returnUrl']:array('slim/city/admin'),
                'class' => 'btn'
            ));
