        ...
        <div class="span8"> <!-- main inputs -->
            ...
            <div class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            ...
                            <span class="help-block">
                                ...
                                <?php
                                echo ($t = Yii::t('crud', 'Country.country_id') != 'Country.country_id')?$t:''
                                ?>
                                                            </span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            <?php
                            echo $form->textField($model,'country',array('size'=>50,'maxlength'=>50));
                            echo $form->error($model,'country')
                            ?>
                            <span class="help-block">
                                
                                <?php
                                echo ($t = Yii::t('crud', 'Country.country') != 'Country.country')?$t:''
                                ?>
                                                            </span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class='controls'>
                            ...
                            <span class="help-block">
                                ...
                                <?php
                                echo ($t = Yii::t('crud', 'Country.last_update') != 'Country.last_update')?$t:''
                                ?>
                                                            </span>
                        </div>
                    </div>
    ...
    <div class="form-actions">
        ...
        <?php
            ...
            Yii::t('crud', 'Cancel'), array(
                'submit' => (isset($_GET['returnUrl']))?$_GET['returnUrl']:array('slim/country/admin'),
                'class' => 'btn'
            ));
