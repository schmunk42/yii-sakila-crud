<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-random', 'items'=>array(array('icon'=>'circle-arrow-left','label'=>'Language', 'url' =>array('language/admin')),array('icon'=>'circle-arrow-left','label'=>'OriginalLanguage', 'url' =>array('language/admin')),array('icon'=>'resize-horizontal','label'=>'Actors', 'url' =>array('actor/admin')),array('icon'=>'resize-horizontal','label'=>'Categories', 'url' =>array('category/admin')),array('icon'=>'arrow-right','label'=>'Inventories', 'url' =>array('inventory/admin')),
            )
          ),
        ),
    ));
